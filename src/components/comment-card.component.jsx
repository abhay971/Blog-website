...
const CommentCard = ({ index, leftVal, commentData }) => {
    ...
    const LoadMoreRepliesButton = () => {
        ...
        let button = <button onClick={() => loadReplies({ skip: index - parentIndex, currentIndex: parentIndex })} className="text-dark-grey p-2 px-3 hover:bg-grey/30 rounded-xl flex items-center gap-2">Load More Replies...</button>
            ...
            <div className="my-5 p-6 rounded-md border border-grey">
                ...
                <div className="flex gap-5 items-center mt-5">

                    {
                        ...
                        <button className="text-dark-grey p-2 px-3 hover:bg-grey/30 rounded-xl flex items-center gap-2" onClick={hideReplies}>
                            <i className="fi fi-rs-comment-dots"></i>Hide Reply
                        </button> : 
                        <button className="text-dark-grey p-2 px-3 hover:bg-grey/30 rounded-xl flex items-center gap-2" onClick={loadReplies}>
...

                    {
                        ...
                        <button className="p-2 px-3 rounded-md ml-auto hover:text-red flex items-center" onClick={deleteComments}>
