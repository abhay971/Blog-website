...
//             return toast.error(`Write a description about your blog ${characterLimit} characters to publish`)
//         }
...
//                     <div className="w-full aspect-video rounded-3xl overflow-hidden bg-grey mt-4">
//                         <img src ={banner} className="rounded-3xl z-20 " />
//                     </div>
...
//                     <p className="text-dary-grey mb-2 mt-9">Blog Title</p>
//                     <input type="text" placeholder="Blog Title" defaultValue={title} className="input-box pl-4" 
//                     onChange={handleBlogTitleChange}
//                     />

//                     <p className="text-dary-grey mb-2 mt-9">Short Description about your Blog</p>
...
//                     <p className="text-dary-grey mb-2 mt-9">Topics - ( Helps in searching and ranking your blog post )</p>
