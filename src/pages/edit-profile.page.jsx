                ...
                <form ref={editProfileForm}>
                    ...
                    <div className="flex flex-col lg:flex-row items-start py-10 gap-8 lg:gap-10">
                        ...
                        <div className="max-lg:center mb-5">
                            <label htmlFor="uploadImg" id="profileImageLable" className="relative block w-48 h-48 bg-grey rounded-full overflow-hidden">
                        ...
                        <div className="w-full">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 md:gap-5">
                                <div>
                                    <InputBox name="fullname" type="text" value={fullname} placeholder="Full Name" disable={true} icon="fi-sr-user" />
                                </div>
                                <div>
                                    <InputBox name="email" type="text" value={email} placeholder="Email" disable={true} icon="fi-sr-envelope" />
                                </div>
                            </div>

                            <InputBox type="text" name="username" value={profile_username} placeholder="Username" icon="fi-bs-at" />

                            <p className="text-dark-grey -mt-3 font-gelasio">Username will use to search user and will be visible to all users.</p>
                            ...
                            <p className="font-gelasio mt-1 text-dark-grey">{ charactersLeft } Characters left</p>

                            <p className="my-6 text-dark-grey font-gelasio">Add your Social handles below :</p>
